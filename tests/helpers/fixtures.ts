...
export const buildProject = (overrides: Partial<Project> = {}): Project => {
  ...
  return {
    ...
    activeManifestId: overrides.activeManifestId ?? null,
    activeScenarioPackId: overrides.activeScenarioPackId ?? null,
    activeScenarioRunId: overrides.activeScenarioRunId ?? null,
